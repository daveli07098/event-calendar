...
CRITICAL — extract ALL sale windows into saleDates (one entry per distinct date/type):
  ...
  Sale windows are often application RANGES "open〜close" (e.g. "FC最速先行：10月13日(火)17:00〜10月18日(日)23:59"): put the open in date/time and the close in endDate/endTime of the SAME entry — never a second entry for the close. Windows with only an open moment get endDate=null.
